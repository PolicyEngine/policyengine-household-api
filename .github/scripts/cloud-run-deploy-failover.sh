...
append_observability_env() {
  ...
  local observability_log_name="${OBSERVABILITY_GOOGLE_CLOUD_LOG_NAME:-policyengine-observability}"
  ...
  append_env_value "${env_file}" OBSERVABILITY_GOOGLE_CLOUD_LOG_NAME "${observability_log_name}"
