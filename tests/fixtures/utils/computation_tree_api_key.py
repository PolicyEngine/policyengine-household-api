...
def mock_anthropic_client():
    ...
    with patch("policyengine_household_api.utils.computation_tree.anthropic.Anthropic") as mock_anthropic_class:
...
def mock_parse_claude_message():
    ...
    with patch("policyengine_household_api.utils.computation_tree.parse_string_from_claude_message") as mock_parse:
