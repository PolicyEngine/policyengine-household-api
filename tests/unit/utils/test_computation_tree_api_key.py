...
class TestComputationTreeAPIKey:
    ...
    def test__given_api_key__triggers_streaming_analysis(
    ...
    def test__given_api_key__triggers_buffered_analysis(
        self, mock_anthropic_client, mock_parse_claude_message
    ):
